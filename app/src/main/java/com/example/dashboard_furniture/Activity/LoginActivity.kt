...
import com.example.dashboard_furniture.viewmodel.LoginViewModel
import com.example.dashboard_furniture.viewmodel.LoginViewModelFactory
...
class LoginActivity : AppCompatActivity(), View.OnClickListener, View.OnFocusChangeListener, View.OnKeyListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel =  ViewModelProvider(this, LoginViewModelFactory(pref)).get(
        ...
        viewModel.isTravel.observe(this, {
            goToMainMenu(it)
        })
    ...
    fun goToMainMenu(isTravel: Boolean){
        if(isTravel){
